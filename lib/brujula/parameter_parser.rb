class Brujula::ParameterParser

  attr_reader :definition, :parameters

  def initialize(definition:, parameters:)
    @definition = definition
    @parameters = parameters
  end

  def call
    parametize(definition.dup)
  end
  ...
  def transformer_functions
    @transformer_functions = Brujula::TransformerFunctions.new
  end
